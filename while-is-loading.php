...
Plugin URI: http://pisfato.com/wordpress/plugin/while-loading
...
if(!class_exists('WhileLoading')){
	final class WhileLoading{
		...
		public function writeOnBodyTheme(){
			...
			$ggm = -1;?>
			<div id="display-loading" style="<?php echo $style; ?>">
				<h1 id="title-loading"><?php echo get_option('el_titulo'); ?></h1>
			<?php
